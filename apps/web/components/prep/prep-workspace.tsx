...
export function PrepWorkspace() {
  ...
  async function resetDemo() { try { await prepData.reset(); setEditingCoding(null); setBehavioralOpen(null); setEditingSystem(null); setToast("Prep demo data restored."); } catch { /* Hook exposes the typed error state. */ } }

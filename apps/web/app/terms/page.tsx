...
export default function TermsPage() {
  return <LegalPage title="Terms of Service" updated="July 27, 2026">
    ...
    <LegalSection title="Gmail-assisted tracking"><p>Recruiting email classifications, application matches, dates, and proposed status changes may be incomplete or inaccurate. You must review each suggestion before accepting it and remain responsible for important deadlines. OfferOS does not send, modify, label, archive, delete, or mark Gmail messages read through this integration.</p></LegalSection>
